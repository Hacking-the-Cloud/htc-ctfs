...
curl -H "PRIVATE-TOKEN: $1" -X PUT "http://localhost/api/v4/application/appearance?title=SoftHouseIO%20GitLab%20Instance&description=The%20PREMERE%20web%20dev%20shop!"
